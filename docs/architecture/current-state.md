...
1. **TODO в main.rs:**
   - "坦克碰撞导致被迫移动" - Танки при столкновении вынуждены двигаться

2. **TODO в enemy.rs:**
   - "发现玩家后主动攻击" - Враги должны активно атаковать при обнаружении игрока
   - "树林可躲藏" - Деревья должны обеспечивать укрытие

3. **TODO в level.rs:**
   - "游戏胜利" - Реализация экрана победы
